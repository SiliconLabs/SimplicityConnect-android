...
import com.siliconlabs.bledemo.gatt_configurator.activities.GattServerActivity
import com.siliconlabs.bledemo.gatt_configurator.dialogs.DescriptorDialog
import com.siliconlabs.bledemo.gatt_configurator.models.Characteristic
...
import com.siliconlabs.bledemo.gatt_configurator.views.GattDescriptorView.DescriptorListener
...
class GattCharacteristicView(context: Context, attributeSet: AttributeSet? = null) : FrameLayout(context, attributeSet) {
    ...
    private fun initView(characteristic: Characteristic) {
        ...
        tv_characteristic_uuid.text = context.getString(R.string.UUID_colon).plus(" ").plus(characteristic.uuid?.getAsFormattedText())
