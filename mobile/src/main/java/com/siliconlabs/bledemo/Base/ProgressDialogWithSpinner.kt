...
class ProgressDialogWithSpinner(context: Context, private val caption: String, private val animate: Boolean, private val imageViewResourceId: Int, private val cancelable: Boolean = true) : ProgressDialog(context) {
