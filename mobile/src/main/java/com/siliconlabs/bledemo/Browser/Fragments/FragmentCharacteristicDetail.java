...
import com.siliconlabs.bledemo.Bluetooth.DataTypes.ServiceCharacteristic;
...
import com.siliconlabs.bledemo.Bluetooth.Parsing.Unit;
...
public class FragmentCharacteristicDetail extends Fragment {
    ...
    public BluetoothGattCharacteristic mBluetoothCharact;
        ...
        if (unit != null) {
            if (!TextUtils.isEmpty(unit.getSymbol())) {
                if (unit.getFullName().toLowerCase().equals("celsius") || unit.getFullName().toLowerCase().equals("fahrenheit")) {
                    ...
                    fieldUnitView.setText(context.getString(R.string.unit_with_whitespace,Html.fromHtml(unit.getSymbol())));
                } else {
                    fieldUnitView.setText(context.getString(R.string.unit_with_whitespace,unit.getSymbol()));
                }
            } else {
                fieldUnitView.setText(context.getString(R.string.unit_with_whitespace,unit.getFullName()));
            }
        }
    ...
    private EditText addValueEdit(final Field field, String value) {
        ...
        fieldValueEdit.setBackgroundResource(R.drawable.et_custom_color);
