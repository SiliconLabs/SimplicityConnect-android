...
public class FragmentCharacteristicDetail extends Fragment {
    ...
    private void writeValueToCharacteristic() {
        ...
        if (hexEdit != null) {
            ...
            int size = hexToByteArray(hex).length;
            byte[] newValue = new byte[size];
            newValue = hexToByteArray(hex);
            try{
        ...
        /*if (isRawValue || parseProblem) {
            ...
            if (hexEdit != null) {
                ...
                if (null != value) {
                    byte[] originalBytes = new byte[value.length];
                    ...
                    mBluetoothCharact.setValue(originalBytes);
                    Log.d("write_val", "Raw Value to write (hex): " + Converters.getHexValue(newValue));
                }
            }
        } else {
            mBluetoothCharact.setValue(value);
