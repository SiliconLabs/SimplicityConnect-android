package com.siliconlabs.bledemo.wifi_commissioning.adapters
...
import com.siliconlabs.bledemo.wifi_commissioning.adapters.AccessPointsAdapter.AccessPointViewHolder
...
class AccessPointsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AccessPointViewHolder {
        val itemView = LayoutInflater.from(parent.context)
                .inflate(R.layout.access_point_list_item, parent, false)
